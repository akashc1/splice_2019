...
h5f.create_dataset('NAME', data=np.asarray(NAME).astype(h5py.string_dtype()))
h5f.create_dataset('PARALOG', data=np.asarray(PARALOG))
h5f.create_dataset('CHROM', data=np.asarray(CHROM).astype(h5py.string_dtype()))
h5f.create_dataset('STRAND', data=np.asarray(STRAND).astype(h5py.string_dtype()))
h5f.create_dataset('TX_START', data=np.asarray(TX_START).astype(h5py.string_dtype()))
h5f.create_dataset('TX_END', data=np.asarray(TX_END).astype(h5py.string_dtype()))
h5f.create_dataset('JN_START', data=np.asarray(JN_START).astype(h5py.string_dtype()))
h5f.create_dataset('JN_END', data=np.asarray(JN_END).astype(h5py.string_dtype()))
h5f.create_dataset('SEQ', data=np.asarray(SEQ).astype(h5py.string_dtype()))
